...
public class UploadedRecipe {
    ...
    public UploadedRecipe(long id, String name, String cookTime, String prepTime, String totalTime, String level,
                          String servings, String directions, String imageUrl,
